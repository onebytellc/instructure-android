...
public class ColorContext {
    ...
    public static void getColor(final Context context, final CanvasContext canvasContext, final CanvasColorCallback callback) {
        ...
        UserManager.getColors(new StatusCallback<CanvasColor>(new StatusCallback.StatusDelegate() {
            @Override
     ...
     */
    public static void setNewColor(final CanvasContext canvasContext, final int color) {
        addToCache(canvasContext, color);
        UserManager.setColors(new StatusCallback<CanvasColor>(new StatusCallback.StatusDelegate() {
            @Override
            public boolean hasNetworkConnection() {
                return true;
            }
        }){}, canvasContext.getContextId(), color);
    }
