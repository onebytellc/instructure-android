...
public class LoaderUtils {
     ...
     */
    public static <G extends android.support.v4.app.LoaderManager.LoaderCallbacks> void restoreLoaderFromBundle(android.support.v4.app.LoaderManager loaderManager, Bundle saveState, G callback, int loaderId) {
     ...
     * @param bundleId - unique ID for bundle saveState
     */
    public static <G extends android.support.v4.app.LoaderManager.LoaderCallbacks> void restoreLoaderFromBundle(android.support.v4.app.LoaderManager loaderManager, Bundle saveState, G callback, int loaderId, String bundleId) {
     ...
     * @param <G> - generic reference to callback
     */
    public static <G extends android.support.v4.app.LoaderManager.LoaderCallbacks> void restartLoaderWithBundle(android.support.v4.app.LoaderManager loaderManager, Bundle loaderBundle, G callback, int loaderId){
