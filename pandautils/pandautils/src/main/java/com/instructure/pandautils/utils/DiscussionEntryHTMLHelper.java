...
public class DiscussionEntryHTMLHelper {
    ...
    public static String getHTML(DiscussionEntry discussionEntry, Context context, int index, String deletedString, String colorString, boolean isForbidden, boolean shouldAllowRating, boolean canReply, int currentRatingForUser, String likeString, int subEntryCount) {
        ...
        String status = discussionEntry.isUnread() ? "unread_message" : "read_message";
    ...
    public static String getReadState(DiscussionEntry discussionEntry) {
        return discussionEntry.isUnread() ? "unread" : "read";
    }
    ...
    private static String formatCommentsCount(Context context, int count) {
        if(count == 0) {
            ...
            return String.format(Locale.getDefault(), context.getString(R.string.word_space_word), count, context.getString(R.string.discussion_responses));
        } else {
            return String.format(Locale.getDefault(), context.getString(R.string.word_space_word), count, context.getString(R.string.discussion_response));
        }
    }
    ...
    private static String formatUnreadCount(Context context, int count) {
        if(count == 0) {
            ...
            return String.format(Locale.getDefault(), context.getString(R.string.word_space_word), count, context.getString(R.string.discussion_unread));
        }
    }
