...
public abstract class CanvasContext extends CanvasModel<CanvasContext> {
     ...
     */
    @Nullable
    public static CanvasContext fromContextCode(String contextCode) {

        if (contextCode == null || contextCode.isEmpty()) return null;

        String[] codeParts = contextCode.split("_");
    ...
    public static String getApiContext(CanvasContext canvasContext) {
