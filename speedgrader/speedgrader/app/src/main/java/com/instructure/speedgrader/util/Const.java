...
public class Const {
    ...
    public static final String noSubmissionsForAssignment = "There are no submissions for this assignment";
    public static final String userHasNoSubmission        = "This student does not have a submission for this assignment";
