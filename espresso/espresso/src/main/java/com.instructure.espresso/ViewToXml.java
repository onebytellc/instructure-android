...
public class ViewToXml {
     ...
     * Download with adb pull /sdcard/Android/data/com.instructure.candroid/cache/dump
     **/
    ...
    /**
     * Invoke ViewToXml.dumpView(); from a test to dump the view
     **/
    public static void dumpView() {
        boolean dumpResult = ViewToXml.dumpToFile(RootView.get());
