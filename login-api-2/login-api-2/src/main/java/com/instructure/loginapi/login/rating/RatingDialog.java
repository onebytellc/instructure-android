...
public class RatingDialog extends DialogFragment {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(message)) {
                    ...
                    if (appName == RatingDialog.APP_NAME.CANDROID) {
                        appTitle = getString(R.string.canvas);
                    } else if (appName == RatingDialog.APP_NAME.POLLING) {
                        appTitle = getString(R.string.polls);
                    } else if (appName == RatingDialog.APP_NAME.SPEEDGRADER) {
                        appTitle = getString(R.string.speedgrader);
                    } else if (appName == RatingDialog.APP_NAME.PARENT) {
                        appTitle = getString(R.string.canvas_parent);
                    } else if (appName == RatingDialog.APP_NAME.TEACHER) {
                        appTitle = getString(R.string.canvas_teacher);
                    }
                    //they provided some feedback, so we will open an email with their suggestion populated
                    Intent intent = populateMailIntent(getString(R.string.suggestions) + " - " + appTitle, message);
    ...
    private Intent populateMailIntent(String subject, String title) {
        ...
        User user = APIHelper.getCacheUser(getActivity());
        ...
        if(user != null) {
            ...
            emailBody += getActivity().getString(R.string.email) + ": " + user.getPrimaryEmail() + "\n";
        }
        emailBody += getActivity().getString(R.string.domain) + ": " + APIHelper.getDomain(getActivity()) + "\n";
