...
public abstract class SyncExpandablePresenter<GROUP, MODEL extends CanvasComparable, VIEW extends SyncExpandableManager>
    ...
    protected int compare(GROUP group, MODEL item1, MODEL item2) {
        return 0;
    }

    protected int compare(GROUP group1, GROUP group2) {
        return 0;
    }
    ...
    protected boolean areContentsTheSame(GROUP group1, GROUP group2) {
        return false;
    }
    ...
    protected boolean areItemsTheSame(GROUP group1, GROUP group2) {
        return false;
    }
    ...
    public StatusCallback.StatusDelegate mStatusDelegate = new StatusCallback.StatusDelegate() {
        ...
        public boolean hasNetworkConnection() {
            return getViewCallback() == null || getViewCallback().statusDelegate().hasNetworkConnection();
        }
    };
}
