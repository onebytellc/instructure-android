...
public class StickyGridHeadersBaseAdapterWrapper extends BaseAdapter {
    ...
    private final com.stickygridheaders.StickyGridHeadersBaseAdapter mDelegate;
    ...
    public StickyGridHeadersBaseAdapterWrapper(Context context, StickyGridHeadersGridView gridView,
            com.stickygridheaders.StickyGridHeadersBaseAdapter delegate) {
        mContext = context;
        mDelegate = delegate;
        mGridView = gridView;
     ...
     */
    public com.stickygridheaders.StickyGridHeadersBaseAdapter getWrappedAdapter() {
        return mDelegate;
    }
