...
public class StickyGridHeadersSimpleAdapterWrapper extends BaseAdapter implements
        com.stickygridheaders.StickyGridHeadersBaseAdapter {
    private com.stickygridheaders.StickyGridHeadersSimpleAdapter mDelegate;

    private HeaderData[] mHeaders;

    public StickyGridHeadersSimpleAdapterWrapper(com.stickygridheaders.StickyGridHeadersSimpleAdapter adapter) {
        mDelegate = adapter;
