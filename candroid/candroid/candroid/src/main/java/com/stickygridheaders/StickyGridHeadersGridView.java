...
import com.stickygridheaders.*;
import com.stickygridheaders.StickyGridHeadersBaseAdapterWrapper;
...
public class StickyGridHeadersGridView extends GridView implements OnScrollListener,
    ...
    protected com.stickygridheaders.StickyGridHeadersBaseAdapterWrapper mAdapter;
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        com.stickygridheaders.StickyGridHeadersBaseAdapter baseAdapter;
        if (adapter instanceof com.stickygridheaders.StickyGridHeadersBaseAdapter) {
            baseAdapter = (com.stickygridheaders.StickyGridHeadersBaseAdapter)adapter;
        ...
        this.mAdapter = new com.stickygridheaders.StickyGridHeadersBaseAdapterWrapper(getContext(), this, baseAdapter);
    ...
    private int findMotionHeader(float y) {
        ...
        for (int i = getFirstVisiblePosition(); i <= getLastVisiblePosition();) {
            ...
            if (id == com.stickygridheaders.StickyGridHeadersBaseAdapterWrapper.ID_HEADER) {
    ...
    private void scrollChanged(int firstVisibleItem) {
        ...
        if (childCount != 0) {
            ...
            for (int i = 0; i < childCount; i += mNumMeasuredColumns) {
                ...
                if (mAdapter.getItemId(getPositionForView(child)) == com.stickygridheaders.StickyGridHeadersBaseAdapterWrapper.ID_HEADER
