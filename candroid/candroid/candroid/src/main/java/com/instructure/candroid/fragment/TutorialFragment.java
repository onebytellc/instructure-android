...
public class TutorialFragment extends Fragment {
    ...
    private int[] backgroundColorResIds = new int[]{
            R.color.tutorialPage1, R.color.tutorialPage2, R.color.tutorialPage3, R.color.tutorialPage4
    };

    private int[] backgroundImageResIds_phone = new int[]{
            R.drawable.android_tutorial_screen_phone_1, R.drawable.android_tutorial_screen_phone_2,
            R.drawable.android_tutorial_screen_phone_3, R.drawable.android_tutorial_screen_phone_4
    };

    private int[] backgroundImageResIds_smallTablet = new int[]{
            R.drawable.android_tutorial_screen_small_tab_1, R.drawable.android_tutorial_screen_small_tab_2,
            R.drawable.android_tutorial_screen_small_tab_3, R.drawable.android_tutorial_screen_small_tab_4
    };

    private int[] backgroundImageResIds_tablet = new int[]{
            R.drawable.android_tutorial_screen_tab_1, R.drawable.android_tutorial_screen_tab_2,
            R.drawable.android_tutorial_screen_tab_3, R.drawable.android_tutorial_screen_tab_4
    };

    private int[] imageText = new int[]{
            R.string.tutorialPage1, R.string.tutorialPage2, R.string.tutorialPage3, R.string.tutorialPage4
    };
