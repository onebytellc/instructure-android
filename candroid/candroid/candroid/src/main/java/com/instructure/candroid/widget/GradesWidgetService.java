...
public class GradesWidgetService extends CanvasWidgetService {

    @Override
    public Intent getRefreshIntent() {
        Intent updateIntent = new Intent(this, GradesWidgetProvider.class);
    ...
    public void setWidgetDependentViews(RemoteViews remoteViews, int appWidgetId, int textColor) {
        remoteViews.setRemoteAdapter(R.id.contentList, GradesViewWidgetService.createIntent(this, appWidgetId));
        remoteViews.setTextViewText(R.id.widget_title, this.getString(R.string.gradesWidgetTitle));
