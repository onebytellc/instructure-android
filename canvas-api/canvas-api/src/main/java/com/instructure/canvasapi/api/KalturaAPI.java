...
public class KalturaAPI extends BuildInterfaceAPI {
    ...
    public static Response uploadKalturaFile(String kalturaToken, String uploadToken, TypedFile fileData, String hostUrl) {
        return buildUploadInterfaceXML(KalturaAPIInterface.class, hostUrl).uploadFileAtPath(new TypedString(kalturaToken), new TypedString(uploadToken), fileData);
    }
